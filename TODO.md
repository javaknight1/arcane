...
**Current Task:** T54 (vLLM Infrastructure) — GPU setup, model serving, deployment
**Current Sprint:** S18 (Self-Hosted Models) — Not Started
**Next Milestone:** S18 completion — Self-hosted model support
...
- [x] **T53** - Export to external PM tools via web UI (wire existing Linear/Jira/Notion/CSV exporters) ✓
